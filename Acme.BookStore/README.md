...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p b42f44eb-8387-4b3e-b757-75d574fc38fa
```

> `b42f44eb-8387-4b3e-b757-75d574fc38fa` is the password of the certificate, you can change it to any password you want.
